...
- **Tech Stack**: Rust 2021, serde, serde_json, serde_repr
...
Extract the relevant sections for **cdp_types** and implement:
...
pub type Result<T> = std::result::Result<T, CdptypesError>;
```
...
- Work ONLY in `components/cdp_types/` directory
