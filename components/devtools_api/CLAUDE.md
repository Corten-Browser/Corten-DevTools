...
- **Tech Stack**: Rust 2021, public API, DevToolsConfig
...
Extract the relevant sections for **devtools_api** and implement:
...
pub type Result<T> = std::result::Result<T, DevtoolsapiError>;
```
...
- Work ONLY in `components/devtools_api/` directory
