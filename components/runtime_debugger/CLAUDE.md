...
- **Tech Stack**: Rust 2021, JS runtime bridge integration, breakpoints

## Responsibility
JavaScript Runtime and Debugger domains
...
Extract the relevant sections for **runtime_debugger** and implement:
...
- Work ONLY in `components/runtime_debugger/` directory
